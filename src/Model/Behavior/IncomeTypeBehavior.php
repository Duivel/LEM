...
class IncomeTypeBehavior extends Behavior
{
	public function incomeTypeUpdate(Entity $entity)
	{
		$fields = ['modify_user'];
		if ($entity->isNew()) {
			$fields = ['income_type_id', 'create_user', 'modify_user', 'del_flg'];
		}
