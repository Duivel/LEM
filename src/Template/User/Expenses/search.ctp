					...
					<div class="col-lg-8 col-sm-12 col-md-8">
						...
						<fieldset>
							<div class="form-group">
								...
								<div class="col-lg4 col-sm-4 col-md-4">
							...
							<div class="form-group">
								<label for="date" class="col-lg-2 col-sm-4 control-label">Date</label>
								<div class="col-lg-4 col-sm-4">
							 ...
							 <div class="form-group">
								<label for="user_id" class="col-lg-2 col-sm-4 control-label">User</label>
							 ...
							 <div class="form-group"> 
								<label for="expense_type_id" class="col-lg-2 col-sm-4 control-label">Type</label>
								<div class="col-lg-4 col-sm-8">
