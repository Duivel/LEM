<?php
$title = 'Add a new withdraw';
$breadScrum = 'Add';
$btnValue = 'Add';
$btnName = 'Add';

$isUpdate = empty($withdraw->withdraw_id) ? FALSE : TRUE;
if ($isUpdate) {
	$title = 'Edit an withdraw';
	$breadScrum = 'Edit';
	$btnValue = 'Edit';
	$btnName = 'Edit';
}
...
<div class="row">
	<div class="col-lg-12">
		...
		<ol class="breadcrumb">
			...
			<li><?php echo $this->Html->link('Withdraw Management', ['controller' => 'Withdraws', 'action' => 'view'])?></li>
...
<div class="row">
	<div class="col-lg-6 col-sm-8">
		<?php 
		echo $this->ExForm->create($withdraw, ['url' => ['action' => 'edit'], 'class' => 'form-horizontal']);
		echo $this->ExForm->hidden('withdraw_id');
		?>
		<fieldset>
			...
			<div class="form-group">
				<label for="withdraw_type_id" class="col-lg-3 col-sm-4 control-label">Type</label>
				<div class="col-lg-9 col-sm-8">
					<?php echo $this->ExForm->withdrawType('withdraw_type_id', ['id' => 'withdraw_type_id', 'empty' => false, 'class' => 'form-control']);?>
				</div>
			</div>
			<div class="form-group">
				<div class="col-lg-3 col-sm-4"></div>
				<div class="col-lg-9 col-sm-8">
					<?php echo $this->ExForm->button($btnName, ['class' => 'btn btn-primary', 'value' => $btnValue, 'name' => $btnName, 'type' => 'submit'])?>
				</div>
			</div>
		</fieldset>
